...
public class RefTypes : MonoBehaviour
{
    ...
    void RefContainer()
    {
        new List<object>()
        {
            ...
            new Queue<ValueTuple<int,long,int>>(),
            new MultiMap<long, ValueType>(),
        };
    }
    ...
    void MyAotRefs()
    {
        ...
        dict.Foreach<long,object>((_,obj ) => { return;});
        var dict1 = new MultiMap<long, long>();
        dict1.ForEachFunc((i, boo) => { return true; });
