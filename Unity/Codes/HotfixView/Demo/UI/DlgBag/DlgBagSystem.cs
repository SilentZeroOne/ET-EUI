...
namespace ET
{
    ...
    public static class DlgBagSystem
    {
        ...
        public static void RefreshItems(this DlgBag self)
        {
            ...
            int showCount = itemList == null? 0 : itemList.Count - (self.CurrentPageIndex * self.PageContentSize);
            showCount = showCount > self.PageContentSize? self.PageContentSize : showCount;
        ...
        public static void RefreshPageIndexInfo(this DlgBag self)
        {
            ...
            int maxShowCount = (self.CurrentPageIndex * self.PageContentSize) + self.PageContentSize;
            ...
            int maxPageIndex = Mathf.CeilToInt(itemCount / (float)self.PageContentSize);
            self.View.E_PageText.SetText($"{self.CurrentPageIndex + 1}/{maxPageIndex}");
        }
