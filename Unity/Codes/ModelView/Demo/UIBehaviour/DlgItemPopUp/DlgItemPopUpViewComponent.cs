...
namespace ET
{
	...
	public  class DlgItemPopUpViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Image E_BottomGroundImage
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_E_BottomGroundImage == null )
     			{
		    		this.m_E_BottomGroundImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"ItemBackGroup/E_BottomGround");
     			}
     			return this.m_E_BottomGroundImage;
     		}
     	}
		...
		public UnityEngine.UI.Text E_ScoreText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ScoreText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"ItemBackGroup/E_BottomGround/ScoreTitle/E_Score");
     			}
     			return this.m_E_ScoreText;
     		}
     	}

		public UnityEngine.UI.Text E_SellPriceText
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_E_SellPriceText == null )
     			{
		    		this.m_E_SellPriceText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"ItemBackGroup/E_BottomGround/SellPriceTitle/E_SellPrice");
     			}
     			return this.m_E_SellPriceText;
     		}
     	}
		...
		public void DestroyWidget()
		{
			...
			this.m_E_BottomGroundImage = null;
			this.m_E_ScoreText = null;
			this.m_E_SellPriceText = null;
		...
		private UnityEngine.UI.Image m_E_BottomGroundImage = null;
		private UnityEngine.UI.Text m_E_ScoreText = null;
		private UnityEngine.UI.Text m_E_SellPriceText = null;
