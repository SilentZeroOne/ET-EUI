		...
		public UnityEngine.UI.LoopVerticalScrollRect E_ChatLoopVerticalScrollRect
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_ChatLoopVerticalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopVerticalScrollRect>(this.uiTransform.gameObject,"Background/ChatBackground/E_Chat");
     			}
		...
		public UnityEngine.UI.InputField E_MessageInputField
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_MessageInputField = UIFindHelper.FindDeepChild<UnityEngine.UI.InputField>(this.uiTransform.gameObject,"Background/E_Message");
     			}
		...
		public UnityEngine.UI.Image E_MessageImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_MessageImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Background/E_Message");
     			}
		...
		public UnityEngine.UI.Button E_SendButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SendButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Background/E_Send");
     			}
		...
		public UnityEngine.UI.Image E_SendImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SendImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"Background/E_Send");
     			}
