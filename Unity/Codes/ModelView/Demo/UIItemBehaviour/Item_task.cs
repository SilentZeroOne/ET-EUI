		...
		public UnityEngine.UI.Text E_TaskNameText
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_TaskNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"TopBackground/E_TaskName");
     				}
     				return this.m_E_TaskNameText;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"TopBackground/E_TaskName");
     			}
     		}
     	}
		...
		public UnityEngine.UI.Text E_TaskProgressText
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_TaskProgressText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TaskProgressTip/E_TaskProgress");
     				}
     				return this.m_E_TaskProgressText;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TaskProgressTip/E_TaskProgress");
     			}
     		}
     	}
		...
		public UnityEngine.UI.Text E_TaskRewardText
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_TaskRewardText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TaskRewardTip/E_TaskReward");
     				}
     				return this.m_E_TaskRewardText;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_TaskRewardTip/E_TaskReward");
     			}
     		}
     	}
