		...
		public UnityEngine.UI.Text E_ConsumeTypeText
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_ConsumeTypeText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_ConsumeType");
     				}
     				return this.m_E_ConsumeTypeText;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_ConsumeType");
     			}
     		}
     	}
		...
		public UnityEngine.UI.Text E_ConsumeCountText
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_ConsumeCountText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_ConsumeType/E_ConsumeCount");
     				}
     				return this.m_E_ConsumeCountText;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_ConsumeType/E_ConsumeCount");
     			}
     		}
     	}
