...
{
	[EnableMethod]
	public  class Scroll_Item_itemEntry : Entity,IAwake,IDestroy,IUIScrollItem 
	{
		...
		public Scroll_Item_itemEntry BindTrans(Transform trans)
		{
		...
		public UnityEngine.UI.Text E_EntryValueText
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_EntryValueText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_EntryName/E_EntryValue");
     				}
     				return this.m_E_EntryValueText;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_EntryName/E_EntryValue");
     			}
     		}
     	}
