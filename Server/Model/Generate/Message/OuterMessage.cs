...
namespace ET
{
	...
	[Message(OuterOpcode.C2A_CrerateRole)]
	[ProtoContract]
	public partial class C2A_CrerateRole: Object, IRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class A2C_CreateRole: Object, IActorResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ResponseType(nameof(M2C_UpdateTaskInfo))]
